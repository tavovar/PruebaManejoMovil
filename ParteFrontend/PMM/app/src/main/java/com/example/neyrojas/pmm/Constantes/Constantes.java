package com.example.neyrojas.pmm.Constantes;
...
public class Constantes {
    ...
    public static String idtw = "77294746353";

    public static String pregunta = "Complete la siguiente afirmación: Las señales verticales de prevención son de color";
    public static int numMiniPregNotaAprov = 7;
    public static int maximoNumPregTestTeo = 10;
    public static int numMiniPregNotaAprovPractico = 4;
    public static int maximoNumPregTestPractico = 6;
    ...
    // CONSTANTES DE URL
    public static String URLSubSeccion = "http://www.pruebamanejomovil.com:8080/app/subseccion";
    ...
    public static int tiempoLimite = 6;
